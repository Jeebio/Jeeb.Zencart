...
class jeeb extends base
{
  ...
  function jeeb()
  {
    ...
    $this->expiration       = MODULE_PAYMENT_JEEB_EXPIRATION;
    $this->base_cur         = "";
    $this->target_cur       = "";
    $this->lang             = "";

    if (isset($this->expiration) === false ||
        is_numeric($this->expiration) === false ||
        $this->expiration < 15 ||
        $this->expiration > 2880) {
        $this->expiration = 15;
    }
  ...
  function after_process()
  {
    ...
    $amount = \Jeeb\Merchant\Order::convert_base_to_bitcoin($order_total, $signature, $baseCur);
    ...
    $params = array(
      ...
      'allowReject'      => MODULE_PAYMENT_JEEB_ALLOW_REFUND == "True" ? true : false,
      "coins"            => $targetCur,
    ...
    $token = \Jeeb\Merchant\Order::create_payment($params, $signature);
    $this->log('Token = '.$token.' Params ='.$params['requestAmount'], true);

    echo \Jeeb\Merchant\Order::redirect_payment($token);
  ...
  function install()
  {
    ...
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values('Enable Jeeb Module', 'MODULE_PAYMENT_JEEB_STATUS', 'False', 'Enable the Jeeb Payments plugin?', '6', '0', 'zen_cfg_select_option(array(\'True\', \'False\'), ', now())");
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values('Language', 'MODULE_PAYMENT_JEEB_LANG', 'False', 'The language of the Jeeb\'s payment area.', '6', '8', 'zen_cfg_select_option(array(\'Auto-Select\', \'English\', \'Persian\'), ', now())");
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values('Signature', 'MODULE_PAYMENT_JEEB_API_KEY', '0', 'The signature provided by Jeeb for you merchant.', '6', '0', now())");
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values('Expiration Time', 'MODULE_PAYMENT_JEEB_EXPIRATION', '0', 'Expands default payments expiration time. It should be between 15 to 2880 (mins).', '6', '0', now())");
    ...
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values('Alow Testnets', 'MODULE_PAYMENT_JEEB_TEST', 'False', 'Allows testnets such as TBTC to get processed.', '6', '1', 'zen_cfg_select_option(array(\'True\', \'False\'), ', now())");
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values('Allow Refund', 'MODULE_PAYMENT_JEEB_ALLOW_REFUND', 'False', 'Allows payments to be refunded.', '6', '1', 'zen_cfg_select_option(array(\'True\', \'False\'), ', now())");
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values('Base currency', 'MODULE_PAYMENT_JEEB_BASE_CUR', 'False', 'The Base currency of your site.', '6', '1', 'zen_cfg_select_option(array(\'BTC\', \'IRR\', \'EUR\', \'TOMAN\', \'USD\'), ', now())");
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values('Payable currencies', 'MODULE_PAYMENT_JEEB_TARGET_CUR', 'False', 'The currencies which users can use for payments.', '6', '1', 'zen_cfg_select_multioption(array(\'BTC\', \'XRP\', \'ETH\', \'XMR\', \'BCH\', \'LTC\', \'TEST-BTC\',\'TEST-LTC\'), ', now())");
    ...
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) values('Set Refunded Order Status', 'MODULE_PAYMENT_JEEB_REFUNDED_STATUS_ID', '7', 'Status in your store when Jeeb Invoice status is refunded.<br />(\'Refunded\' recommended)', '6', '6', 'zen_cfg_pull_down_order_statuses(', 'zen_get_order_status_name', now())");
  }
  ...
  function keys()
  {
    return array(
      ...
      'MODULE_PAYMENT_JEEB_EXPIRATION',
      ...
      'MODULE_PAYMENT_JEEB_REFUNDED_STATUS_ID',
      'MODULE_PAYMENT_JEEB_BASE_CUR',
      'MODULE_PAYMENT_JEEB_TARGET_CUR',
      'MODULE_PAYMENT_JEEB_ALLOW_REFUND',
